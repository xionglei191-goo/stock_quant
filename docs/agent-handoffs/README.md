...
- Related tasks: T-406C, T-406D, T-406E, T-424-T-429, T-431-T-602
...
Use [TEMPLATE.md](./TEMPLATE.md) as the starting point. The template mirrors the current mandatory sections enforced by `scripts/check_handoffs.py`; do not remove required sections merely because a task is small.
