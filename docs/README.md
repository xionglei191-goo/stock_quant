...
- [api-contracts.md](./api-contracts.md): 接口契约；包含公司画像、画像字段抽取、字段断言冲突/批量复核、本地公司材料 inbox 脚本、公司包导入运行历史、画像深字段覆盖审计、事件/关系质量归并、研报观点、观察结论和模拟反馈 API
