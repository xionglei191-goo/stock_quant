...
构建一个以公开披露信息、授权数据和审计留痕为基础的研究增强型投研与组合管理系统，支持 A/H/U 三市场、中低频、人工审批的工作模式。
...
- A/H/U 三市场公开披露、结构化财务和授权 EOD/延时数据接入。
...
- 高频/秒级交易。
- 无授权研报抓取和复用。
- 未经许可的实时 non-display 数据使用。
- 未经核验版权的电话会转录和第三方会议纪要。
- 脱离人工审批的仓位变更。

## 项目假设

- 第一阶段优先接入官方披露与授权来源，不处理灰色来源数据。
- MVP 团队规模按 4-7 人估算。
- 研究增强和决策治理优先于组合自动化。
...
| M2 | 数据授权与证据链跑通 | 数据源授权清单明确 | 三市场研究结论可回链到原始证据 |
