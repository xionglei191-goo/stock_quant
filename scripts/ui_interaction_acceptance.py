    ...
    try:
        ...
        checks = [
            ...
            _run_check(
                ...
                "document.querySelector('#companyIntelRelationshipReviewStatus').textContent.includes('待复核') && document.querySelector('#companyIntelRelationshipCandidateCount').textContent.includes('1') && document.querySelector('#companyIntelRelationshipRecommendationStatus').textContent.includes('1/1') && document.querySelector('#companyIntelRelationshipReviewRows').textContent.includes('Demo Customer') && document.querySelector('#companyIntelRelationshipReviewRows').textContent.includes('prefer') && selectedCompanyRelationshipIds().includes('rel_demo_candidate') && document.querySelector('#companyIntelRelationshipReviewRows [data-action=\"review-company-relationship\"][data-review-action=\"approve\"]') !== null",
                wait_timeout=max(timeout, 20.0),
            ),
            _run_check(
                client,
